...
<body>
    ...
    <div class="container my-5">
        <h1 class="fw-bolder fs-1 text-center mb-5">Loan Applications</h1>
        <div class="row justify-content-center p-3">
            ...
            ?>
                    <div class="col-xs-12 col-md-6 mx-3 mb-3 px-5 py-5 shadow-lg" style="width: 600px; border-radius:10px;">
                        ...
                        <p style="margin-bottom: 3px;"><span class="fw-bold fs-6">Occupation </span>: <?php echo $result['Occupation']; ?></p>
                        <p style="margin-bottom: 3px;"><span class="fw-bold fs-6">Loan Amount </span>: <?php echo $result['loan_amount']; ?></p>
                        <p style="margin-bottom: 3px;"><span class="fw-bold fs-6">Loan Reason </span>: <?php echo $result['loan_reason']; ?></p>
                        <p style="margin-bottom: 3px;"><span class="fw-bold fs-6">Address </span> : <?php echo $result['Address']; ?></p>
